...
@st.cache_resource  # ADD THIS!
def load_yolo_model(model_path: str, model_type: str):
    """Load YOLO model with caching - prevents memory leaks"""
...
class YOLOProcessor:
    ...
    def load_model(self, model_path: str, model_type: str = "yolo") -> bool:
        ...
        try:
            # Use cached version instead of YOLO(model_path)
            self.model = load_yolo_model(model_path, model_type)
